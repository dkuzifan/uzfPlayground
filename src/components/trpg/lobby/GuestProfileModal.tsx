...
export default function GuestProfileModal({ open, onSave }: GuestProfileModalProps) {
  ...
  return (
    <Modal open={open} onClose={() => {}} title="">
      <div className="mb-1 text-lg font-bold text-neutral-900 dark:text-white">
        환영합니다! 프로필을 설정하세요
      </div>
      ...
      <div className="mb-5">
        <label className="mb-1.5 block text-xs font-medium text-neutral-600 dark:text-neutral-400">
          닉네임 <span className="text-red-500 dark:text-red-400">*</span>
        </label>
        <input
          type="text"
          maxLength={13}
        ...
        />
        {nicknameError && (
          <p className="mt-1 text-xs text-red-500 dark:text-red-400">{nicknameError}</p>
        )}
        {!nicknameError && (
      ...
      <div className="mb-6">
        <label className="mb-2 block text-xs font-medium text-neutral-600 dark:text-neutral-400">
          아바타 <span className="text-red-500 dark:text-red-400">*</span>
        </label>
