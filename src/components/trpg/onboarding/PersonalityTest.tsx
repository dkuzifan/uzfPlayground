...
// ── 씬 데이터 (12개) ──────────────────────────────────────────────────────────
// 설계 원칙: 각 씬의 4선택지 축 합 = 0 (기댓값 편향 제거)
// 에니어그램: 타입당 5~6 primary slots (균등 배분)

const SCENES: Scene[] = [
  {
    // Focus: GE + EI | Enn primary: A=2, B=8, C=5, D=3
    title: "길 위의 낯선 이",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: 1, sn: 0, tf: -2, jp: 0, enn: [[2, 3], [9, 1]], lc: 0, ge: 2 },
      },
      {
        label: '"짐을 여기 두고 내일 다시 오세요"라고 조언하고 혼자 서두른다. 지금은 내가 안전해야 한다.',
        score: { ei: -1, sn: 1, tf: 2, jp: 1, enn: [[8, 3], [3, 1]], lc: 0, ge: -2 },
      },
      {
        label: "가방에서 지도를 꺼내 둘 다 살 수 있는 가장 빠른 경로를 함께 계산한다.",
        score: { ei: 0, sn: 1, tf: 1, jp: 1, enn: [[5, 3], [1, 1]], lc: 0, ge: 1 },
      },
      {
        label: "근처 마을에서 짐꾼을 구해주겠다고 약속하고 먼저 달려간다. 직접 돕는 것보다 실질적인 해결책이다.",
        score: { ei: 0, sn: -2, tf: -1, jp: -2, enn: [[3, 3], [2, 1]], lc: 0, ge: -1 },
      },
    ],
  },
  {
    // Focus: LC + SN | Enn primary: A=6, B=7, C=5, D=1
    title: "마을의 금지 구역",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: 1, sn: 1, tf: -1, jp: 2, enn: [[6, 3], [1, 1]], lc: 2, ge: 1 },
      },
      {
        label: "밤에 몰래 숲에 들어간다. 나의 목적이 더 중요하고, 무지한 금기일 뿐이다.",
        score: { ei: -1, sn: -1, tf: 1, jp: -2, enn: [[7, 3], [8, 1]], lc: -2, ge: -1 },
      },
      {
      ...
      },
      {
        ...
        score: { ei: 0, sn: 2, tf: -2, jp: 1, enn: [[1, 3], [6, 1]], lc: 0, ge: 0 },
      },
    ],
  },
  {
    // Focus: TF + LC | Enn primary: A=1, B=9, C=3, D=7
    title: "경매의 유혹",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: 0, sn: 0, tf: -1, jp: 1, enn: [[1, 3], [6, 1]], lc: 2, ge: 2 },
      },
      {
        label: "경매가 끝나길 기다린다. 나와 상관없는 일에 끼어들 이유가 없다.",
        score: { ei: -2, sn: 0, tf: 0, jp: 0, enn: [[9, 3], [5, 1]], lc: 0, ge: 0 },
      },
      {
        label: "그 정보를 협상 카드로 써서 상인에게 더 낮은 가격에 거래를 제안한다.",
        score: { ei: 1, sn: -1, tf: 2, jp: 0, enn: [[3, 3], [8, 1]], lc: -1, ge: -1 },
      },
      {
        label: "몰수되면 혼란을 틈타 내가 먼저 손에 넣는 방법을 찾는다.",
        score: { ei: 1, sn: 1, tf: -1, jp: -1, enn: [[7, 3], [4, 1]], lc: -1, ge: -1 },
      },
    ],
  },
  {
    // Focus: EI + GE | Enn primary: A=2, B=6, C=9, D=3
    title: "파벌 다툼",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: 2, sn: 0, tf: -2, jp: 0, enn: [[2, 3], [9, 1]], lc: 0, ge: 2 },
      },
      {
        label: "길드 쪽에 서서 그들을 지지한다. 조직과 규율이 있는 쪽이 옳다.",
        score: { ei: 1, sn: 1, tf: 1, jp: 1, enn: [[6, 3], [1, 1]], lc: 1, ge: 0 },
      },
      {
      ...
      },
      {
        ...
        score: { ei: -1, sn: -1, tf: 1, jp: -1, enn: [[3, 3], [8, 1]], lc: -1, ge: -2 },
      },
    ],
  },
  {
    // Focus: TF + JP | Enn primary: A=6, B=5, C=2, D=4
    title: "부상자의 선택",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: 0, sn: 0, tf: 1, jp: 2, enn: [[6, 3], [8, 1]], lc: 0, ge: -1 },
      },
      {
        label: "부상 정도를 직접 살펴보고 객관적으로 가장 위험한 사람에게 준다.",
        score: { ei: 0, sn: 2, tf: 2, jp: 1, enn: [[5, 3], [1, 1]], lc: 0, ge: 1 },
      },
      {
        label: "포션을 쪼개서 셋에게 나눈다. 효과가 줄더라도 모두를 돕는다.",
        score: { ei: 0, sn: -1, tf: -2, jp: -1, enn: [[2, 3], [9, 1]], lc: 0, ge: 2 },
      },
      {
        label: "누구에게 줄지 세 사람이 직접 결정하게 한다. 내가 판단할 일이 아니다.",
        score: { ei: 0, sn: -1, tf: -1, jp: -2, enn: [[4, 3], [7, 1]], lc: 0, ge: -2 },
      },
    ],
  },
  {
    // Focus: LC + GE | Enn primary: A=1, B=8, C=5, D=4
    title: "비밀의 무게",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: 0, sn: 0, tf: -1, jp: 2, enn: [[1, 3], [6, 1]], lc: 2, ge: 2 },
      },
      {
        label: "시장과 직접 만나 개인적으로 압박해 협력을 끌어낸다. 정보는 힘이다.",
        score: { ei: 1, sn: -1, tf: 2, jp: 0, enn: [[8, 3], [3, 1]], lc: -1, ge: -2 },
      },
      {
        label: "증거를 안전하게 보관하고 지금 당장은 아무것도 하지 않는다. 타이밍이 중요하다.",
        score: { ei: -1, sn: 1, tf: 1, jp: -2, enn: [[5, 3], [9, 1]], lc: 0, ge: 0 },
      },
      {
        label: "시민들이 알아야 한다. 익명으로 증거를 유포한다.",
        score: { ei: 0, sn: 0, tf: -2, jp: 0, enn: [[4, 3], [2, 1]], lc: -1, ge: 0 },
      },
    ],
  },
  {
    // Focus: SN + JP | Enn primary: A=3, B=9, C=7, D=2
    title: "폐허 속 발견",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: -1, sn: 2, tf: 1, jp: 2, enn: [[3, 3], [5, 1]], lc: 1, ge: 0 },
      },
      {
        label: "다수결로 정하자고 제안한다. 모두가 원하는 방향으로 가는 게 맞다.",
        score: { ei: 2, sn: -1, tf: -1, jp: -1, enn: [[9, 3], [2, 1]], lc: 0, ge: 1 },
      },
      {
        label: "아무도 가지 않을 것 같은 가장 이상하게 생긴 문을 선택한다. 평범한 루트에는 평범한 것만 있다.",
        score: { ei: -1, sn: -2, tf: 0, jp: -2, enn: [[7, 3], [4, 1]], lc: -2, ge: 0 },
      },
      {
        label: '"뭘 찾고 싶냐"고 각자에게 물어본 뒤 목적에 맞는 방향을 권한다.',
        score: { ei: 0, sn: 1, tf: 0, jp: 1, enn: [[2, 3], [6, 1]], lc: 1, ge: -1 },
      },
    ],
  },
  {
    // Focus: EI + LC | Enn primary: A=6, B=1, C=9, D=8
    title: "왕국의 명령",
    background:
    ...
    choices: [
      ...
      },
      {
        ...
        score: { ei: 2, sn: 0, tf: 0, jp: 1, enn: [[1, 3], [6, 1]], lc: 1, ge: 1 },
      },
      {
        label: "마을에 몰래 경고를 보내고 명령은 형식적으로만 이행한다. 사람이 다치지 않으면 된다.",
        score: { ei: -1, sn: -1, tf: -1, jp: -2, enn: [[9, 3], [2, 1]], lc: -2, ge: 2 },
      },
      {
        label: "명령을 공개적으로 거부한다. 부당한 명령에는 복종할 수 없다.",
        score: { ei: 0, sn: 0, tf: 0, jp: -1, enn: [[8, 3], [4, 1]], lc: -1, ge: -2 },
      },
    ],
  },
  {
    // Focus: TF + GE | Enn primary: A=4, B=3, C=5, D=8
    title: "명성의 기회",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: -2, sn: 0, tf: -2, jp: 0, enn: [[4, 3], [8, 1]], lc: 0, ge: -1 },
      },
      {
        label: "수락한다. 실질적 지원이 더 중요하며, 명성은 언젠가 다른 방식으로 얻을 수 있다.",
        score: { ei: 0, sn: 1, tf: 2, jp: 1, enn: [[3, 3], [7, 1]], lc: 1, ge: 0 },
      },
      {
        label: "협상한다. 발견자 기록을 내부 문서로는 남기되 공표를 조정하는 타협안을 제시한다.",
        score: { ei: 1, sn: -1, tf: 1, jp: 1, enn: [[5, 3], [3, 1]], lc: 1, ge: 2 },
      },
      {
        label: "수락하지만 다른 루트로 원본 문서를 유출해 진실을 남긴다. 이름은 어떻게든 역사에 남는다.",
        score: { ei: 1, sn: 0, tf: -1, jp: -2, enn: [[8, 3], [4, 1]], lc: -2, ge: -1 },
      },
    ],
  },
  {
    // Focus: JP + SN | Enn primary: A=1, B=4, C=2, D=7
    title: "마지막 야영지",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: -1, sn: 2, tf: 1, jp: 2, enn: [[1, 3], [6, 1]], lc: 1, ge: 0 },
      },
      {
        label: "근처 숲을 혼자 산책하며 생각을 정리한다.",
        score: { ei: -2, sn: -1, tf: -1, jp: -1, enn: [[4, 3], [5, 1]], lc: 0, ge: 0 },
      },
      {
        label: "일행이 있다면 함께 이야기를 나누거나, 없다면 모닥불 앞에서 여정 일지를 쓴다.",
        score: { ei: 2, sn: 1, tf: -1, jp: 1, enn: [[2, 3], [9, 1]], lc: 0, ge: 0 },
      },
      {
        label: "내일은 내일 생각하기로 하고, 지금 이 순간의 별빛과 고요함을 즐긴다.",
        score: { ei: 1, sn: -2, tf: 1, jp: -2, enn: [[7, 3], [9, 1]], lc: -1, ge: 0 },
      },
    ],
  },
  {
    // Focus: EI + JP | Enn primary: A=3, B=9, C=2, D=4
    title: "진실의 대가",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: 1, sn: 1, tf: 2, jp: 2, enn: [[3, 3], [1, 1]], lc: 2, ge: 1 },
      },
      {
      ...
      },
      {
        ...
        score: { ei: -2, sn: 0, tf: 0, jp: 1, enn: [[4, 3], [2, 1]], lc: -2, ge: -2 },
      },
    ],
  },
  {
    // Focus: GE + LC | Enn primary: A=6, B=7, C=8, D=5
    title: "분기점",
    background:
    ...
    choices: [
      {
        ...
        score: { ei: 0, sn: 2, tf: 0, jp: 2, enn: [[6, 3], [1, 1]], lc: 1, ge: 1 },
      },
      {
        label: "미지의 길을 선택한다. 새로운 발견이 기다릴 것 같고, 미지의 공간이 나를 끌어당긴다.",
        score: { ei: 0, sn: -2, tf: 0, jp: -2, enn: [[7, 3], [5, 1]], lc: -1, ge: 0 },
      },
      {
        label: "미지의 길을 선택한다. 아무도 가지 않은 곳을 내가 먼저 간다는 것 자체가 의미 있다.",
        score: { ei: 0, sn: -1, tf: 0, jp: -1, enn: [[8, 3], [4, 1]], lc: -2, ge: -1 },
      },
      {
        label: "알려진 루트를 선택하되, 도중에 미개척 지류를 탐색하는 병행 계획을 세운다.",
        score: { ei: 0, sn: 1, tf: 0, jp: 1, enn: [[5, 3], [3, 1]], lc: 2, ge: 0 },
      },
    ],
  },
];
...
function calcMBTI(sc: TotalScores, ch: number[]): MBTIType {
  // Tiebreakers (sc axis sums = 0, so ties are relatively rare):
  // EI=0: sc4(idx3) A/B→E, C/D→I
  // SN=0: sc7(idx6) A(sn+2) or D(sn+1)→S, else→N
  // TF=0: sc5(idx4) A/B→T, C/D→F
  // JP=0: sc10(idx9) A(jp+2) or C(jp+1)→J, else→P
  const e = sc.EI > 0 ? "E" : sc.EI < 0 ? "I" : (ch[3] <= 1 ? "E" : "I");
  const s = sc.SN > 0 ? "S" : sc.SN < 0 ? "N" : (ch[6] === 0 || ch[6] === 3 ? "S" : "N");
  const t = sc.TF > 0 ? "T" : sc.TF < 0 ? "F" : (ch[4] <= 1 ? "T" : "F");
  const j = sc.JP > 0 ? "J" : sc.JP < 0 ? "P" : (ch[9] === 0 || ch[9] === 2 ? "J" : "P");
...
function calcEnneagram(sc: TotalScores, ch: number[]): EnneagramType {
  ...
  // Tiebreaker pairs — scene indices updated for new score design:
  if (pair.has(1) && pair.has(6))  return ch[7] === 1 ? 1 : 6;   // sc8(idx7): B→1, A→6
  if (pair.has(2) && pair.has(9))  return ch[3] === 0 ? 2 : 9;   // sc4(idx3): A→2, C→9
  if (pair.has(3) && pair.has(7))  return ch[6] === 0 ? 3 : 7;   // sc7(idx6): A→3, C→7
  if (pair.has(4) && pair.has(5))  return ch[8] === 0 ? 4 : 5;   // sc9(idx8): A→4, C→5
  if (pair.has(8) && pair.has(1))  return ch[5] === 1 ? 8 : 1;   // sc6(idx5): B→8, A→1
...
function calcDnD(sc: TotalScores, ch: number[]): DnDAlignment {
  ...
  if (sc.LC >= 2)       law = "lawful";
  else if (sc.LC <= -2) law = "chaotic";
  else if (sc.LC === 0) law = (ch[1] === 0 || ch[1] === 3) ? "lawful" : "chaotic"; // sc2: A/D→L, B→C
  else                  law = "neutral";

  let good: "good" | "neutral" | "evil";
  if (sc.GE >= 2)       good = "good";
  else if (sc.GE <= -2) good = "evil";
